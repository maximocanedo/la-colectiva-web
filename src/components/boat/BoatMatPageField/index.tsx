import {IBoatMatPageFieldProps} from "./defs";
...
const BoatMatPageField = ({me, mat: n, onUpdate, author, id }: IBoatMatPageFieldProps): React.JSX.Element => {
    ...
    return (
        <EditableField
            langPath={"components.boat.BoatMatPageField"}
            initialValue={mat}
            editable={canEdit}
            onChange={(value: string): void => {setValue(value.trim().toUpperCase())}}
...
export default BoatMatPageField;